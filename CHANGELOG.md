...
- Native rows capture their column names at query time, and Next and Scan refuse to run after Close. The protocol result object is per-connection scratch; reading it after the connection returned to the pool could observe a later query's columns.
...
[Unreleased]: https://github.com/go-rio/clickhouse/compare/v0.9.6...HEAD
[0.9.6]: https://github.com/go-rio/clickhouse/compare/v0.9.5...v0.9.6
[0.9.5]: https://github.com/go-rio/clickhouse/compare/v0.9.4...v0.9.5
